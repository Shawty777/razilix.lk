...
if(isset($_POST["chkPublish"]))
{
	...
	else
	{
		...
		$con = mysqli_connect("localhost","root","","IT21709548","3308");
		
		$sql = "INSERT INTO `tbladvertisement` (`advertisementID`, `productName`, `description`, `publish`, `imagePath`, `contactNumber`, `category`, `email`) VALUES (NULL,'".$productname."','".$description."','".$contactnumber."','".$category."','".$image."','".$_SESSION["userName"]."');";
